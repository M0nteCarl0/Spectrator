...
int  CPUInformation::  GetLogicalCPUCount(void)
{
	return _LogicalCoresCount;
}

int CPUInformation:: GetPhysicalCPUCount(void)
{
	return _PhysicalCoresCount;
}
...
bool  CPUInformation:: GetProcessorFeatureFlagsExtended(ProcessorFeatureFlagsExtended Feature)
{
	return (_ProcessorFeatureExtended & 1<<Feature)!=0;
}

bool  CPUInformation::GetProcessorFeatureFlagsExtendedEx(ProcessorFeatureFlagsExtendedEx Feature)
{
	return( _ProcessorFeatureEx & 1<<Feature)!=0;
}

bool CPUInformation::GetProcessorFeatureFlagsExtendedExEDX(ProcessorFeatureFlagsExtendedExEDX Feature)
{
	return( _ProcessorFeatureExEDX & 1<<Feature)!=0;
}

bool CPUInformation::GetProcessorFeatureFlagsECX(ProcessorFeatureFlagsECX Feature)
{
	return (_ProcessorFeatureExtended &  1 << Feature) != 0;
}
...
string	CPUInformation:: GetVendorname(void)
{
	return   _Vendorname;
}

string	CPUInformation::GetBrandName(void)
{
	return _BrandName;
}

int		CPUInformation::GetStepingID(void)
{
	return _StepingID;
}

int	 CPUInformation::GetModelNumber(void)
{
	return _ModelNumber;
}

int	CPUInformation::GetFamilyCode(void)
{
	return _FamilyCode;
}

int	CPUInformation::GetType(void)
{
	return _Type;
}

int	CPUInformation::GetExtendedModel(void)
{
	return _ExtendedModel;
}

int CPUInformation:: GetExtendeFamily(void)
{
	return _ExtendeFamily;
}
...
int CPUInformation:: GetFamily(void)
{
	return _ExtendeFamily + _FamilyCode;
}
...
int  CPUInformation:: GetMaximumCacheLevel(void)
{
	 return _RawCachesInfo.size();
   
}

int   CPUInformation:: GetCacheSize(int Level)
{
	  return  GetCacheWaysAssociativity(Level) * GetCachePhysicalLineSizePartitions(Level) * GetCacheCoherencyLineSize(Level) * GetCacheNumberofSets(Level);
}
...
int CPUInformation::GetSignature(void)
{
	return _ProcessorSignature;
}

int CPUInformation::GetCacheAccesCapabylity(int Level,CacheAccesCapabylity Capabylity)
{
	 return  _RawCachesInfo[Level]._EDX & Capabylity;
}

 CPUID_CPUVendor CPUInformation:: GetCPUVendor(void)
 {
     return _CPUVendor;
 }
 
 int CPUInformation:: GetCCXCount(void)
 {
	 return _CCXCount;
 }
