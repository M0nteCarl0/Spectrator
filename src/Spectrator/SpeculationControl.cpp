...
bool SpeculationControl::GetSpeculationCapabylitiesAvallibility(IA32_ARCH_CAPABILITIES_MSR_FLAG Flag)
{
...
bool SpeculationControl::GetSpeculationControlSettingsActivity(IA32_SPEC_CTRL_MSR_FLAG Flag)
{
	return ((IA32_SPEC_CTRL & Flag) != 0);
}

void SpeculationControl::SetSpeculationControlFlagState(IA32_SPEC_CTRL_MSR_FLAG Flag, bool State)
{
	if (State)
	{
		IA32_SPEC_CTRL |= Flag;
...
void SpeculationControl::SetStatePredictionControl(IA32_PRED_CMD_MSR_FLAG Flag, bool State)
{
...
void SpeculationControl::SetStateFlushCaches(IA32_FLUSH_CMD_MSR_FLAG Flag, bool State)
{
	if (State)
	{
		IA32_FLUSH_CMD |= Flag;
