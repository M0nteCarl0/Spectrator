...
public:
	...
	bool GetProcessorFeatureFlagsExtendedEx(ProcessorFeatureFlagsExtendedEx Feature);
	bool GetProcessorFeatureFlagsExtendedExEDX(ProcessorFeatureFlagsExtendedExEDX Feature);
