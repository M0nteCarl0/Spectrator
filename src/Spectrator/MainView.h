...
namespace Spectrator {
	...
	public:
		MainView(void)
		{
			...
			if (!_CPUInformation->GetProcessorFeatureFlagsExtendedExEDX(ProcessorFeatureFlagsExtendedExEDX_IBRS_IBPB))
			{
			...
			if (!_CPUInformation->GetProcessorFeatureFlagsExtendedExEDX(ProcessorFeatureFlagsExtendedExEDX_STIBP))
			{
			...
			if (!_CPUInformation->GetProcessorFeatureFlagsExtendedExEDX(ProcessorFeatureFlagsExtendedExEDX_SSBD))
			{
			...
			if (!_CPUInformation->GetProcessorFeatureFlagsExtendedExEDX(ProcessorFeatureFlagsExtendedExEDX_L1D_FLUSH))
			{
			...
			INVPCID_support_checkBox->Checked = _CPUInformation->GetProcessorFeatureFlagsExtendedEx(ProcessorFeatureFlagsExtendedEx_INVPCID);
			SMAP_support_checkBox->Checked = _CPUInformation->GetProcessorFeatureFlagsExtendedEx(ProcessorFeatureFlagsExtendedEx_SMAP);
			SMEP_support_checkBox->Checked = _CPUInformation->GetProcessorFeatureFlagsExtendedEx(ProcessorFeatureFlagsExtendedEx_SMEP);
			PCID_support_checkBox->Checked = _CPUInformation->GetProcessorFeatureFlagsECX(ProcessorFeatureFlagsECX_PCID);
			...
			if (_CPUInformation->GetProcessorFeatureFlagsExtendedExEDX(ProcessorFeatureFlagsExtendedExEDX_IA32_ARCH_CAPABILITIES))
			{
				IA32_ARCH_CAPABILITIES_support_checkBox->Checked = true;
				_SpeculationControl->GetSpeculationCapabylities();
				RDCL_NO_checkBox->Checked = _SpeculationControl->GetSpeculationCapabylitiesAvallibility(IA32_ARCH_CAPABILITIES_MSR_FLAG_RDCL_NO);
				IBRS_ALL_checkBox->Checked = _SpeculationControl->GetSpeculationCapabylitiesAvallibility(IA32_ARCH_CAPABILITIES_MSR_FLAG_IBRS_ALL);
				RSBA_checkBox->Checked = _SpeculationControl->GetSpeculationCapabylitiesAvallibility(IA32_ARCH_CAPABILITIES_MSR_FLAG_RSBA);
				SKIP_L1DFL_VMENTRY_checkBox->Checked = _SpeculationControl->GetSpeculationCapabylitiesAvallibility(IA32_ARCH_CAPABILITIES_MSR_FLAG_SKIP_L1DFL_VMENTRY);
				SSB_NO_checkBox->Checked = _SpeculationControl->GetSpeculationCapabylitiesAvallibility(IA32_ARCH_CAPABILITIES_MSR_FLAG_SSB_NO);
			}
			else
			{
			...
			SSBDHardwareVulnerable_checkBox->Checked = _WindowsSpeculationControl->GetSpeculationControlFlags().SpeculationControlFlags.SpeculativeStoreBypassDisableRequired;
			SSBDHardwarePresent_checkBox->Checked = _WindowsSpeculationControl->GetSpeculationControlFlags().SpeculationControlFlags.SpeculativeStoreBypassDisableSupported;
			SSBDWindowsSupportPresent_checkBox->Checked = _WindowsSpeculationControl->GetSpeculationControlFlags().SpeculationControlFlags.SpeculativeStoreBypassDisableAvailable;
			SSBDWindowsSupportEnabledSystemWide_checkBox->Checked = _WindowsSpeculationControl->GetSpeculationControlFlags().SpeculationControlFlags.SpeculativeStoreBypassDisabledSystemWide;

			KVAShadowRequired_checkBox->Checked = _WindowsSpeculationControl->GetKvaShadowFlags().KvaShadowFlags.KvaShadowRequired;
			KVAShadowPcidEnabled_checkBox->Checked = _WindowsSpeculationControl->GetKvaShadowFlags().KvaShadowFlags.KvaShadowInvpcid;
			KVAShadowWindowsSupportEnabled_checkBox->Checked = _WindowsSpeculationControl->GetKvaShadowFlags().KvaShadowFlags.KvaShadowEnabled;
			KVAShadowWindowsSupportPresent_checkBox->Checked = _WindowsSpeculationControl->GetKvaShadowFlags().KvaShadowFlags.KvaShadowRequiredAvailable;

			L1TFHardwareVulnerable_checkBox->Checked    = _WindowsSpeculationControl->GetSpeculationControlFlags().SpeculationControlFlags.SpeculativeStoreBypassDisableRequired;
			L1TFWindowsSupportEnabled_checkBox->Checked = _WindowsSpeculationControl->GetKvaShadowFlags().KvaShadowFlags.L1DataCacheFlushSupported;
			L1TFWindowsSupportPresent_checkBox->Checked = _WindowsSpeculationControl->GetKvaShadowFlags().KvaShadowFlags.L1TerminalFaultMitigationPresent;

			BTIHardwarePresent_checkBox->Checked = !_WindowsSpeculationControl->GetSpeculationControlFlags().SpeculationControlFlags.BpbDisabledNoHardwareSupport;
			BTIDisabledBySystemPolicy_checkBox->Checked = _WindowsSpeculationControl->GetSpeculationControlFlags().SpeculationControlFlags.BpbDisabledSystemPolicy;
			BTIWindowsSupportEnabled_checkBox->Checked = _WindowsSpeculationControl->GetSpeculationControlFlags().SpeculationControlFlags.BpbEnabled;
			BTIWindowsSupportPresent_checkBox->Checked = (_WindowsSpeculationControl->GetSpeculationControlFlags().SpeculationControlFlags.IbrsPresent || _WindowsSpeculationControl->GetSpeculationControlFlags().SpeculationControlFlags.StibpPresent) != 0;

			_SpeculationControl->SetNumProcessors(_CPUInformation->GetLogicalCPUCount());
			IBRS_checkBox->Checked = _SpeculationControl->GetSpeculationControlSettingsActivity(IA32_SPEC_CTRL_MSR_FLAG_IBRS);
			STIBP_checkBox->Checked = _SpeculationControl->GetSpeculationControlSettingsActivity(IA32_SPEC_CTRL_MSR_FLAG_STIBP);
			SSBD_checkBox->Checked = _SpeculationControl->GetSpeculationControlSettingsActivity(IA32_SPEC_CTRL_MSR_FLAG_SSBD);
			CPUID_Processor_Name->Text = gcnew String(_CPUInformation->GetBrandName().c_str());
			CPUID_Processor_Family->Text = String::Format("0x{0:X}", _CPUInformation->GetSignature());
			CPUID_Processor_Microcode->Text = String::Format("0x{0:X}", _SpeculationControl->GetMicrocodeVersion());
	...
	private: System::Windows::Forms::CheckBox^  BTIDisabledByNoHardwareSupport_checkBox;

	private: System::Windows::Forms::CheckBox^  BTIDisabledBySystemPolicy_checkBox;

	private: System::Windows::Forms::CheckBox^  BTIWindowsSupportEnabled_checkBox;

	private: System::Windows::Forms::CheckBox^  BTIWindowsSupportPresent_checkBox;

	private: System::Windows::Forms::CheckBox^  BTIHardwarePresent_checkBox;

	private: System::Windows::Forms::CheckBox^  KVAShadowWindowsSupportEnabled_checkBox;

	private: System::Windows::Forms::CheckBox^  KVAShadowWindowsSupportPresent_checkBox;

	private: System::Windows::Forms::CheckBox^  KVAShadowRequired_checkBox;

	private: System::Windows::Forms::Button^  ReadSpecualtionControl;

	private: System::Windows::Forms::TabControl^  tabControl1;
	private: System::Windows::Forms::TabPage^  tabPage1;
	private: System::Windows::Forms::GroupBox^  groupBox6;
	private: System::Windows::Forms::Button^  WriteWORegisters;
	...
	private: System::Windows::Forms::CheckBox^  SSBD_support_checkBox;
	private: System::Windows::Forms::CheckBox^  IA32_ARCH_CAPABILITIES_support_checkBox;
	private: System::Windows::Forms::CheckBox^  L1D_FLUSH_support_checkBox;
	private: System::Windows::Forms::CheckBox^  STIBP_support_checkBox;
	private: System::Windows::Forms::CheckBox^  IBRS_AND_IBPB_support_checkBox;
private: System::Windows::Forms::GroupBox^  IA32_ARCH_CAPABILITIES_groupBox;

	private: System::Windows::Forms::CheckBox^  SSB_NO_checkBox;
private: System::Windows::Forms::CheckBox^  SKIP_L1DFL_VMENTRY_checkBox;



private: System::Windows::Forms::CheckBox^  RSBA_checkBox;

private: System::Windows::Forms::CheckBox^  IBRS_ALL_checkBox;

private: System::Windows::Forms::CheckBox^  RDCL_NO_checkBox;
private: System::Windows::Forms::CheckBox^  KVAShadowPcidEnabled_checkBox;

private: System::Windows::Forms::CheckBox^  SSBDWindowsSupportEnabledSystemWide_checkBox;

private: System::Windows::Forms::CheckBox^  SSBDWindowsSupportPresent_checkBox;

private: System::Windows::Forms::CheckBox^  SSBDHardwarePresent_checkBox;

private: System::Windows::Forms::CheckBox^  SSBDHardwareVulnerable_checkBox;
private: System::Windows::Forms::CheckBox^  L1TFWindowsSupportEnabled_checkBox;



private: System::Windows::Forms::CheckBox^  L1TFWindowsSupportPresent_checkBox;

private: System::Windows::Forms::CheckBox^  L1TFHardwareVulnerable_checkBox;
private: System::Windows::Forms::CheckBox^  SMEP_support_checkBox;
private: System::Windows::Forms::CheckBox^  SMAP_support_checkBox;
private: System::Windows::Forms::GroupBox^  groupBox8;
private: System::Windows::Forms::Button^  button2;
private: System::Windows::Forms::Button^  button1;
private: System::Windows::Forms::CheckBox^  PCID_checkBox;

private: System::Windows::Forms::CheckBox^  SMEP_checkBox;

private: System::Windows::Forms::CheckBox^  SMAP_checkBox;

private: System::Windows::Forms::CheckBox^  PCID_support_checkBox;

private: System::Windows::Forms::CheckBox^  INVPCID_support_checkBox;
	...
	protected: 
	private: System::Windows::Forms::ToolStripStatusLabel^  CPUID_Processor_Name;
	private: System::Windows::Forms::ToolStripStatusLabel^  CPUID_Processor_Family;
	private: System::Windows::Forms::ToolStripStatusLabel^  CPUID_Processor_Microcode;
	private: System::Windows::Forms::GroupBox^  groupBox1;
	private: System::Windows::Forms::CheckBox^  STIBP_checkBox;

	private: System::Windows::Forms::CheckBox^  IBRS_checkBox;
	private: System::Windows::Forms::CheckBox^  SSBD_checkBox;
	private: System::Windows::Forms::CheckBox^  IBPB_checkBox;
	private: System::Windows::Forms::CheckBox^  L1D_FLUSH_checkBox;
private: System::Windows::Forms::Button^  WriteSpeculationControl;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->CPUID_Processor_Name = (gcnew System::Windows::Forms::ToolStripStatusLabel());
			this->CPUID_Processor_Family = (gcnew System::Windows::Forms::ToolStripStatusLabel());
			this->CPUID_Processor_Microcode = (gcnew System::Windows::Forms::ToolStripStatusLabel());
			...
			this->BTIDisabledByNoHardwareSupport_checkBox = (gcnew System::Windows::Forms::CheckBox());
			this->BTIDisabledBySystemPolicy_checkBox = (gcnew System::Windows::Forms::CheckBox());
			this->BTIWindowsSupportEnabled_checkBox = (gcnew System::Windows::Forms::CheckBox());
			this->BTIWindowsSupportPresent_checkBox = (gcnew System::Windows::Forms::CheckBox());
			this->BTIHardwarePresent_checkBox = (gcnew System::Windows::Forms::CheckBox());
			this->groupBox3 = (gcnew System::Windows::Forms::GroupBox());
			this->KVAShadowPcidEnabled_checkBox = (gcnew System::Windows::Forms::CheckBox());
			this->KVAShadowWindowsSupportEnabled_checkBox = (gcnew System::Windows::Forms::CheckBox());
			this->KVAShadowWindowsSupportPresent_checkBox = (gcnew System::Windows::Forms::CheckBox());
			this->KVAShadowRequired_checkBox = (gcnew System::Windows::Forms::CheckBox());
			this->groupBox4 = (gcnew System::Windows::Forms::GroupBox());
			this->SSBDWindowsSupportEnabledSystemWide_checkBox = (gcnew System::Windows::Forms::CheckBox());
			this->SSBDWindowsSupportPresent_checkBox = (gcnew System::Windows::Forms::CheckBox());
			this->SSBDHardwarePresent_checkBox = (gcnew System::Windows::Forms::CheckBox());
			this->SSBDHardwareVulnerable_checkBox = (gcnew System::Windows::Forms::CheckBox());
			this->groupBox5 = (gcnew System::Windows::Forms::GroupBox());
			this->L1TFWindowsSupportEnabled_checkBox = (gcnew System::Windows::Forms::CheckBox());
			this->L1TFWindowsSupportPresent_checkBox = (gcnew System::Windows::Forms::CheckBox());
			this->L1TFHardwareVulnerable_checkBox = (gcnew System::Windows::Forms::CheckBox());
			...
			this->IA32_ARCH_CAPABILITIES_groupBox = (gcnew System::Windows::Forms::GroupBox());
			this->SSB_NO_checkBox = (gcnew System::Windows::Forms::CheckBox());
			this->SKIP_L1DFL_VMENTRY_checkBox = (gcnew System::Windows::Forms::CheckBox());
			...
			this->IA32_ARCH_CAPABILITIES_support_checkBox = (gcnew System::Windows::Forms::CheckBox());
			this->L1D_FLUSH_support_checkBox = (gcnew System::Windows::Forms::CheckBox());
			this->STIBP_support_checkBox = (gcnew System::Windows::Forms::CheckBox());
			this->IBRS_AND_IBPB_support_checkBox = (gcnew System::Windows::Forms::CheckBox());
			...
			this->statusStrip1->Items->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(3) {
				this->CPUID_Processor_Name,
					this->CPUID_Processor_Family, this->CPUID_Processor_Microcode
			});
			...
			this->ReadSpecualtionControl->Click += gcnew System::EventHandler(this, &MainView::ReadSpecualtionControl_Click);
			// 
			...
			this->WriteSpeculationControl->Click += gcnew System::EventHandler(this, &MainView::WriteSpeculationControl_Click);
			// 
			// SSBD_checkBox
			// 
			...
			this->STIBP_checkBox->Text = L"Single Thread Indirect Branch Predictors (STIBP)\r\n";
			...
			this->IBRS_checkBox->Text = L"Indirect Branch Restricted Speculation(IBRS)\r\n";
			...
			// groupBox2
			// 
			this->groupBox2->Controls->Add(this->BTIDisabledByNoHardwareSupport_checkBox);
			...
			this->BTIDisabledByNoHardwareSupport_checkBox->Location = System::Drawing::Point(5, 111);
			this->BTIDisabledByNoHardwareSupport_checkBox->Name = L"BTIDisabledByNoHardwareSupport_checkBox";
			this->BTIDisabledByNoHardwareSupport_checkBox->Size = System::Drawing::Size(503, 17);
			this->BTIDisabledByNoHardwareSupport_checkBox->TabIndex = 5;
			this->BTIDisabledByNoHardwareSupport_checkBox->Text = L"Windows OS support for branch target injection mitigation is disabled by absence "
			...
			this->BTIDisabledBySystemPolicy_checkBox->Location = System::Drawing::Point(6, 88);
			this->BTIDisabledBySystemPolicy_checkBox->Name = L"BTIDisabledBySystemPolicy_checkBox";
			this->BTIDisabledBySystemPolicy_checkBox->Size = System::Drawing::Size(427, 17);
			this->BTIDisabledBySystemPolicy_checkBox->TabIndex = 4;
			this->BTIDisabledBySystemPolicy_checkBox->Text = L"Windows OS support for branch target injection mitigation is disabled by system p"
				L"olicy";
			...
			this->BTIWindowsSupportEnabled_checkBox->Location = System::Drawing::Point(6, 65);
			this->BTIWindowsSupportEnabled_checkBox->Name = L"BTIWindowsSupportEnabled_checkBox";
			this->BTIWindowsSupportEnabled_checkBox->Size = System::Drawing::Size(347, 17);
			this->BTIWindowsSupportEnabled_checkBox->TabIndex = 3;
			this->BTIWindowsSupportEnabled_checkBox->Text = L"Windows OS support for branch target injection mitigation is enabled";
			...
			this->BTIWindowsSupportPresent_checkBox->Location = System::Drawing::Point(6, 42);
			this->BTIWindowsSupportPresent_checkBox->Name = L"BTIWindowsSupportPresent_checkBox";
			this->BTIWindowsSupportPresent_checkBox->Size = System::Drawing::Size(344, 17);
			this->BTIWindowsSupportPresent_checkBox->TabIndex = 2;
			this->BTIWindowsSupportPresent_checkBox->Text = L"Windows OS support for branch target injection mitigation is present";
			...
			this->BTIHardwarePresent_checkBox->Text = L"Hardware support for branch target injection mitigation is present";
			...
			this->groupBox3->Controls->Add(this->KVAShadowWindowsSupportEnabled_checkBox);
			this->groupBox3->Controls->Add(this->KVAShadowWindowsSupportPresent_checkBox);
			...
			this->KVAShadowPcidEnabled_checkBox->Location = System::Drawing::Point(6, 88);
			this->KVAShadowPcidEnabled_checkBox->Name = L"KVAShadowPcidEnabled_checkBox";
			this->KVAShadowPcidEnabled_checkBox->Size = System::Drawing::Size(340, 17);
			this->KVAShadowPcidEnabled_checkBox->TabIndex = 5;
			this->KVAShadowPcidEnabled_checkBox->Text = L"Windows OS support for PCID performance optimization is enabled";
			...
			this->KVAShadowWindowsSupportEnabled_checkBox->Location = System::Drawing::Point(6, 65);
			this->KVAShadowWindowsSupportEnabled_checkBox->Name = L"KVAShadowWindowsSupportEnabled_checkBox";
			this->KVAShadowWindowsSupportEnabled_checkBox->Size = System::Drawing::Size(281, 17);
			this->KVAShadowWindowsSupportEnabled_checkBox->TabIndex = 4;
			this->KVAShadowWindowsSupportEnabled_checkBox->Text = L"Windows OS support for kernel VA shadow is enabled";
			this->KVAShadowWindowsSupportEnabled_checkBox->UseVisualStyleBackColor = true;
			// 
			...
			this->KVAShadowWindowsSupportPresent_checkBox->Location = System::Drawing::Point(6, 42);
			this->KVAShadowWindowsSupportPresent_checkBox->Name = L"KVAShadowWindowsSupportPresent_checkBox";
			this->KVAShadowWindowsSupportPresent_checkBox->Size = System::Drawing::Size(278, 17);
			this->KVAShadowWindowsSupportPresent_checkBox->TabIndex = 3;
			this->KVAShadowWindowsSupportPresent_checkBox->Text = L"Windows OS support for kernel VA shadow is present";
			this->KVAShadowWindowsSupportPresent_checkBox->UseVisualStyleBackColor = true;
			// 
			...
			this->KVAShadowRequired_checkBox->Text = L"Hardware requires kernel VA shadowing";
			this->KVAShadowRequired_checkBox->UseVisualStyleBackColor = true;
			// 
			// groupBox4
			// 
			this->groupBox4->Controls->Add(this->SSBDWindowsSupportEnabledSystemWide_checkBox);
			...
			this->SSBDWindowsSupportEnabledSystemWide_checkBox->Location = System::Drawing::Point(12, 88);
			this->SSBDWindowsSupportEnabledSystemWide_checkBox->Name = L"SSBDWindowsSupportEnabledSystemWide_checkBox";
			this->SSBDWindowsSupportEnabledSystemWide_checkBox->Size = System::Drawing::Size(407, 17);
			this->SSBDWindowsSupportEnabledSystemWide_checkBox->TabIndex = 6;
			this->SSBDWindowsSupportEnabledSystemWide_checkBox->Text = L"Windows OS support for speculative store bypass disable is enabled system-wide";
			this->SSBDWindowsSupportEnabledSystemWide_checkBox->UseVisualStyleBackColor = true;
			// 
			...
			this->SSBDWindowsSupportPresent_checkBox->Location = System::Drawing::Point(12, 65);
			this->SSBDWindowsSupportPresent_checkBox->Name = L"SSBDWindowsSupportPresent_checkBox";
			this->SSBDWindowsSupportPresent_checkBox->Size = System::Drawing::Size(344, 17);
			this->SSBDWindowsSupportPresent_checkBox->TabIndex = 5;
			this->SSBDWindowsSupportPresent_checkBox->Text = L"Windows OS support for speculative store bypass disable is present";
			...
			this->SSBDHardwarePresent_checkBox->Location = System::Drawing::Point(12, 42);
			...
			this->SSBDHardwarePresent_checkBox->Text = L"Hardware support for speculative store bypass disable is present";
			...
			this->SSBDHardwareVulnerable_checkBox->Location = System::Drawing::Point(12, 19);
			this->SSBDHardwareVulnerable_checkBox->Name = L"SSBDHardwareVulnerable_checkBox";
			this->SSBDHardwareVulnerable_checkBox->Size = System::Drawing::Size(265, 17);
			this->SSBDHardwareVulnerable_checkBox->TabIndex = 3;
			this->SSBDHardwareVulnerable_checkBox->Text = L"Hardware is vulnerable to speculative store bypass";
			...
			this->L1TFWindowsSupportEnabled_checkBox->Location = System::Drawing::Point(5, 65);
			this->L1TFWindowsSupportEnabled_checkBox->Name = L"L1TFWindowsSupportEnabled_checkBox";
			this->L1TFWindowsSupportEnabled_checkBox->Size = System::Drawing::Size(316, 17);
			this->L1TFWindowsSupportEnabled_checkBox->TabIndex = 5;
			this->L1TFWindowsSupportEnabled_checkBox->Text = L"Windows OS support for L1 terminal fault mitigation is enabled";
			...
			this->L1TFWindowsSupportPresent_checkBox->Location = System::Drawing::Point(5, 42);
			this->L1TFWindowsSupportPresent_checkBox->Name = L"L1TFWindowsSupportPresent_checkBox";
			this->L1TFWindowsSupportPresent_checkBox->Size = System::Drawing::Size(313, 17);
			this->L1TFWindowsSupportPresent_checkBox->TabIndex = 4;
			this->L1TFWindowsSupportPresent_checkBox->Text = L"Windows OS support for L1 terminal fault mitigation is present";
			...
			this->L1TFHardwareVulnerable_checkBox->Location = System::Drawing::Point(6, 19);
			this->L1TFHardwareVulnerable_checkBox->Name = L"L1TFHardwareVulnerable_checkBox";
			this->L1TFHardwareVulnerable_checkBox->Size = System::Drawing::Size(223, 17);
			this->L1TFHardwareVulnerable_checkBox->TabIndex = 3;
			this->L1TFHardwareVulnerable_checkBox->Text = L"Hardware is vulnerable to L1 terminal fault";
			...
			this->IA32_ARCH_CAPABILITIES_groupBox->Controls->Add(this->SKIP_L1DFL_VMENTRY_checkBox);
			this->IA32_ARCH_CAPABILITIES_groupBox->Controls->Add(this->RSBA_checkBox);
			this->IA32_ARCH_CAPABILITIES_groupBox->Controls->Add(this->IBRS_ALL_checkBox);
			this->IA32_ARCH_CAPABILITIES_groupBox->Controls->Add(this->RDCL_NO_checkBox);
			this->IA32_ARCH_CAPABILITIES_groupBox->Location = System::Drawing::Point(292, 181);
			this->IA32_ARCH_CAPABILITIES_groupBox->Name = L"IA32_ARCH_CAPABILITIES_groupBox";
			this->IA32_ARCH_CAPABILITIES_groupBox->Size = System::Drawing::Size(205, 155);
			...
			this->groupBox7->Controls->Add(this->IA32_ARCH_CAPABILITIES_support_checkBox);
			...
			this->IA32_ARCH_CAPABILITIES_support_checkBox->Location = System::Drawing::Point(6, 94);
			this->IA32_ARCH_CAPABILITIES_support_checkBox->Name = L"IA32_ARCH_CAPABILITIES_support_checkBox";
			this->IA32_ARCH_CAPABILITIES_support_checkBox->Size = System::Drawing::Size(199, 17);
			this->IA32_ARCH_CAPABILITIES_support_checkBox->TabIndex = 4;
			this->IA32_ARCH_CAPABILITIES_support_checkBox->Text = L"IA32_ARCH_CAPABILITIES support";
			this->IA32_ARCH_CAPABILITIES_support_checkBox->UseVisualStyleBackColor = true;
			// 
			...
			this->IBRS_AND_IBPB_support_checkBox->Location = System::Drawing::Point(6, 25);
			this->IBRS_AND_IBPB_support_checkBox->Name = L"IBRS_AND_IBPB_support_checkBox";
			...
			this->WriteWORegisters->Click += gcnew System::EventHandler(this, &MainView::WriteWORegisters_Click);
			// 
			// tabPage2
			// 
...
#pragma endregion
	private: System::Void WriteSpeculationControl_Click(System::Object^  sender, System::EventArgs^  e) {

		_SpeculationControl->SetSpeculationControlFlagState(IA32_SPEC_CTRL_MSR_FLAG_IBRS,IBRS_checkBox->Checked);
		_SpeculationControl->SetSpeculationControlFlagState(IA32_SPEC_CTRL_MSR_FLAG_SSBD,SSBD_checkBox->Checked);
		_SpeculationControl->SetSpeculationControlFlagState(IA32_SPEC_CTRL_MSR_FLAG_STIBP,STIBP_checkBox->Checked);
...
private: System::Void ReadSpecualtionControl_Click(System::Object^  sender, System::EventArgs^  e) {
		_SpeculationControl->GetSpeculationControlSettings();
		IBRS_checkBox->Checked = _SpeculationControl->GetSpeculationControlSettingsActivity(IA32_SPEC_CTRL_MSR_FLAG_IBRS);
		STIBP_checkBox->Checked = _SpeculationControl->GetSpeculationControlSettingsActivity(IA32_SPEC_CTRL_MSR_FLAG_STIBP);
		SSBD_checkBox->Checked = _SpeculationControl->GetSpeculationControlSettingsActivity(IA32_SPEC_CTRL_MSR_FLAG_SSBD);
}
private: System::Void WriteWORegisters_Click(System::Object^  sender, System::EventArgs^  e) {


	if (_CPUInformation->GetProcessorFeatureFlagsExtendedExEDX(ProcessorFeatureFlagsExtendedExEDX_IBRS_IBPB))
	{
		_SpeculationControl->SetStatePredictionControl(IA32_PRED_CMD_MSR_FLAG_IBPB, IBPB_checkBox->Checked);
	...
	if (_CPUInformation->GetProcessorFeatureFlagsExtendedExEDX(ProcessorFeatureFlagsExtendedExEDX_L1D_FLUSH))
	{
		_SpeculationControl->SetStateFlushCaches(IA32_FLUSH_CMD_MSR_FLAG_IA32_FLUSH_CMD, L1D_FLUSH_checkBox->Checked);
